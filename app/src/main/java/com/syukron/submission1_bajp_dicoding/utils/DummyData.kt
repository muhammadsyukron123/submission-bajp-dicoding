...
import com.syukron.submission1_bajp_dicoding.model.movie.MovieGenre
import com.syukron.submission1_bajp_dicoding.model.tvshow.TvShow
import com.syukron.submission1_bajp_dicoding.model.tvshow.TvShowGenre
...
object DummyData {
    ...
    fun generateDummyMovies(): List<Movie> {
        ...
        movies.add(Movie(737568, "", listOf(MovieGenre("genre")), "", "", "", "", 0.0))

        movies.add(Movie(373571, "", listOf(MovieGenre("genre")), "", "", "", "", 0.0))

        movies.add(Movie(577922, "", listOf(MovieGenre("genre")), "", "", "", "", 0.0))

        movies.add(Movie(531499, "", listOf(MovieGenre("genre")), "", "", "", "", 0.0))

        movies.add(Movie(399566, "", listOf(MovieGenre("genre")), "", "", "", "", 0.0))
    ...
    fun generateDummyTvShows(): List<TvShow> {
        ...
        tvShow.add(TvShow(63174, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))

        tvShow.add(TvShow(97175, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))

        tvShow.add(TvShow(79680, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))

        tvShow.add(TvShow(46639, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))

        tvShow.add(TvShow(18165, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))

        tvShow.add(TvShow(1399, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))

        tvShow.add(TvShow(96677, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))

        tvShow.add(TvShow(79611, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))

        tvShow.add(TvShow(75006, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))

        tvShow.add(TvShow(456, "", "", listOf(TvShowGenre("")), "", "", "", 0.0))
